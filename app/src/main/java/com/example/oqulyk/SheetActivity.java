    ...
    private void showTable() {
        ...
        for (int i=1;i<rowSize;i++){
            ...
            for (int j=1;j<=DAY_IN_MONTH;j++){
                ...
                String status=dbHelper.getStatus(idArray[i-1],date); //01.02.2022
        ...
        tableLayout.setShowDividers(TableRow.SHOW_DIVIDER_MIDDLE);
    }
