...
public class TinyDB {
    ...
    public ArrayList<Kitap> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Kitap> playerList =  new ArrayList<Kitap>();

        for(String jObjString : objStrings){
            Kitap player  = gson.fromJson(jObjString,  Kitap.class);
    ...
    public void putListObject(String key, ArrayList<Kitap> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Kitap player: playerList){
